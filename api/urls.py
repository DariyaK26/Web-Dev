...
urlpatterns = [
    ...
    path('tables/<int:table_id>/bookings/', table_bookings, name='table-bookings'),
    path('restaurants/<int:restaurant_id>/available_tables/', available_tables, name='available-tables'),
